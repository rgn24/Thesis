...
The viscosity model of the simulation is carried out using the \verb|blended| method. In this approach, the \verb|arithmetic| and \verb|harmonic| models are combined using a blending factor.
