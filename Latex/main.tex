...
\input{chapters/wettingTheory}

\chapter{Phase Field Method}
\label{chap: PhaseFieldMethod}
\input{chapters/phasefieldmethod}

\chapter{Case Setup}
\label{chap: CaseSetup}
\input{chapters/german/casesetup}
...
\chapter{Results}
\label{chap: Results}
\input{chapters/german/Results.tex}

\chapter{Conclusion and Outlook}
\label{chap: ConclusionandOutlook}
\input{chapters/german/ConclusionandOutlook}
